...
class Ghoul : public Creature 
{
    ...
    private: 
        int level_of_decay_; //An integer representing their level of decay
        Faction faction_; //A Faction representing their faction
        bool can_transform_; //A boolean indicating if they can transform
