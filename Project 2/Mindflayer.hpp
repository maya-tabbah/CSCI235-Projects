...
class Mindflayer : public Creature 
{
    public: 
        ...
        */
        std::string variantToString(const Variant &affinities);

    private: 
        std::vector<Projectile> projectiles_; //A vector of Projectiles
        std::vector<Variant> affinities_; //A vector of Variants representing their affinities
        bool summoning_; //A boolean indicating if they are able to summon a Thoughtspawn
};
