...
class Dragon : public Creature
{
    ...
    private: 
        ...
        Element affinity_; //An Element representing their affinity
        int num_heads_; //An integer representing the number of heads
        bool can_fly_; //A boolean indicating if they can fly
