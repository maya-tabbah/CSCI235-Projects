/*
    ...
    Cavern.hpp = The interface of the subclass of array bag
*/
#include <cmath>
...
class Cavern : public ArrayBag<Creature> 
{
    public: 
        ...
        **/
        bool enterCavern(const Creature &entering);
        ...
        **/
        bool exitCavern(const Creature &exiting);
        ...
        */
        int releaseCreaturesBelowLevel(int removed = 0); 
        ...
        */
        int releaseCreaturesOfCategory(const std::string &removed = "ALL");
    ...
    private: 
        int level_sum_; // An integer sum of the levels of all the creatures currently in the Cavern
        int tame_count_; // An integer count of all the creatures currently in the Cavern that are tame
};
