/*
  ...
  CSCI235 - Spring 2024 
  April 18, 2024 
  Creature.cpp - implementation for Cavern class and Attack stuct
*/
...
{
    return attack_queue_; //this returns a copy not the direct queue
}
 ...
 */
void Creature::addAttack(const Attack &toAdd)
{
    attack_queue_.push(toAdd);
}
