/*
    ...
    CS235 - Spring 2024 
    April 4, 2024 
    Pantry.hpp = interface for the Pantry class as well as the implementation for the Ingredients struct.
*/
...
struct Ingredient
{
    ...
    */
    ...
    Ingredient(const std::string name, const std::string description, int quantity, int price, std::vector<Ingredient> *recipe)
    {
      Ingredient* ing = new Ingredient(name, description, quantity, price, recipe);
    }
...
class Pantry : public LinkedList<Ingredient*>
{
    ...
    */
    ...
    Pantry(const std::string input_file);
    ...
    */
    template<class T>
    int getPosOf(const std::string &ingredient_name) const;
    ...
    */
    template<class T>
    bool contains(const std::string &ingredient_name) const; 
    ...
    */
    bool addIngredient(Ingredient *ing);
    ...
    */
    bool addIngredient(const std::string &ingredient_name, const std::string &ingredient_description, const int &ingredient_quantity, const int &ingredient_price, const std::vector<Ingredient> *recipie); 
    ...
    */
    void canCreate(Ingredient *ing) const;
    ...
    */
    void printIngredient(Ingredient *in) const; 
    ...
    */
    void ingredientQuery(const std::string &ingredient_name) const;
